...
export default function VagasAdv() {
  ...
  useEffect(() => {
    (async () => {
      setCarregando(true);
      const data = await getVagas(ROUTES.VAGAS_ADV);
      setVagasRaw(data);
      setCarregando(false);
    })();
  }, []);
      ...
      >
        <div className="w-[92%] max-w-[1200px] flex flex-col gap-10">
          ...
          <div className="text-center w-full">
            <p className="text-[11px] text-[#FFB703] tracking-[0.3em] uppercase mb-2">
              Direito & Advocacia
            </p>
          ...
          >
            ...
            {/* Grupo de Filtros Selects Estilizados */}
            <div className="flex flex-wrap items-center justify-end gap-3 w-full xl:w-auto">
              <div className="relative flex items-center hidden md:flex">
                ...
                <select
                  ...
                  className="h-[44px] text-[13px] text-white outline-none cursor-pointer appearance-none"
                  style={{
              ...
              <div
                className="flex items-center gap-2 p-1.5 rounded-[12px]"
                style={{
                  background: "rgba(0,0,0,0.2)",
                ...
                {["Remoto", "Híbrido", "Presencial"].map((f) => {
                  ...
                  return (
                    <button
                      ...
                      className="px-5 py-2 rounded-lg text-[13px] whitespace-nowrap transition-all duration-200"
                      style={{
              ...
              <select
                ...
                className="h-[44px] px-4 text-[13px] text-white outline-none cursor-pointer"
                style={{
                  background: "rgba(255,255,255,0.05)",
                  border: "1px solid rgba(255,255,255,0.09)",
                  borderRadius: "10px",
          ...
          {/* Rodapé Inteligente - Contador de Vagas (Identidade Jurídica) */}
          {!carregando && (
